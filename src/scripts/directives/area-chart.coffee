  ...
  .directive "areaChart", ($window, $filter, jsonFormatter) ->
    ...
    link: (scope, element, attrs) ->
      ...
      tip = d3.tip()
        .attr "class", "d3-tip"
        .html (index) ->
          date = $filter('date')(formatted.parties[0].values[index].date, 'fullDate')
      ...
      render = (view) ->
        ...
        partyAreas = chartAreas.selectAll ".area"
          .data formatted.parties
          .enter()
            .append "path"
              .attr "class", (d) -> "#{d.letter} area"
              .attr "fill", (d) -> partyColors.second[d.letter]
        ...
        partyLines = chartLines.selectAll ".line"
          ...
          .enter()
            .append "path"
              .attr "class", (d) -> "line #{d.letter}"
              .attr "stroke", (d) -> partyColors.first[d.letter]
              .attr "stroke-width", 3
        ...
        partyLines2 = controller.selectAll ".partyLines"
          ...
          .enter()
            .append "path"
              .attr "class", (d) -> "partyLines #{d.letter}"
              .attr "stroke", (d) -> partyColors.first[d.letter]
              .attr "stroke-width", 1
              .attr "fill", "transparent"
        ...
        focus.selectAll ".focus-circle"
          ...
          .enter()
            .append "circle"
              .attr "class", (d) -> "focus-circle #{d.letter}"
              .attr "stroke", (d) -> partyColors.first[d.letter]
              .attr "stroke-width", 2
              .attr "fill", "#fff"
              .attr "r", 6
